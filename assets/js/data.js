...
/* Runtime (movies) / season count (shows), director (`by` on movies)
   or creator (`by` on shows), and top cast. Merged into CATALOG below. */
const META = {
...
CATALOG.forEach((m) => Object.assign(m, META[m.id] || {}));
